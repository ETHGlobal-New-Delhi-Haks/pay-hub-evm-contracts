...
const CHEESECHAIN_RPC_URL = process.env.CHEESECHAIN_RPC_URL || "";
const CHEESECHAIN_TESTNET_RPC_URL = process.env.CHEESECHAIN_TESTNET_RPC_URL || "";
const PROOFOFPLAY_BOSS_RPC_URL = process.env.PROOFOFPLAY_BOSS_RPC_URL || "";
const PROOFOFPLAY_BOSS_TESTNET_RPC_URL = process.env.PROOFOFPLAY_BOSS_TESTNET_RPC_URL || "";
const PROOFOFPLAY_APEX_RPC_URL = process.env.PROOFOFPLAY_APEX_RPC_URL || "";
const PROOFOFPLAY_APEX_TESTNET_RPC_URL = process.env.PROOFOFPLAY_APEX_TESTNET_RPC_URL || "";
const MORPH_RPC_URL = process.env.MORPH_RPC_URL || "";
const MORPH_TESTNET_RPC_URL = process.env.MORPH_TESTNET_RPC_URL || "";
const INK_RPC_URL = process.env.INK_RPC_URL || "";
const INK_TESTNET_RPC_URL = process.env.INK_TESTNET_RPC_URL || "";
...
const UNICHAIN_TESTNET_RPC_URL = process.env.UNICHAIN_TESTNET_RPC_URL || "";
const HYPEREVM_RPC_URL = process.env.HYPEREVM_RPC_URL || "";
const HYPEREVM_TESTNET_RPC_URL = process.env.HYPEREVM_TESTNET_RPC_URL || "";
...
const CHEESECHAIN_EXPLORER_API_KEY = process.env.CHEESECHAIN_EXPLORER_API_KEY || "";
const PROOFOFPLAY_BOSS_EXPLORER_API_KEY = process.env.PROOFOFPLAY_BOSS_EXPLORER_API_KEY || "";
const PROOFOFPLAY_APEX_EXPLORER_API_KEY = process.env.PROOFOFPLAY_APEX_EXPLORER_API_KEY || "";
const MORPH_EXPLORER_API_KEY = process.env.MORPH_EXPLORER_API_KEY || "";
const INK_EXPLORER_API_KEY = process.env.INK_EXPLORER_API_KEY || "";
const SONEIUM_EXPLORER_API_KEY = process.env.SONEIUM_EXPLORER_API_KEY || "";
const UNICHAIN_EXPLORER_API_KEY = process.env.UNICHAIN_EXPLORER_API_KEY || "";
const HYPEREVM_EXPLORER_API_KEY = process.env.HYPEREVM_EXPLORER_API_KEY || "";
...
const config: HardhatUserConfig = {
  networks: {
    ...
    cheesechain: {
      url: CHEESECHAIN_RPC_URL,
      accounts: [SIGNER_PRIVATE_KEY],
      chainId: 383353,
    },
    cheesechainTestnet: {
      url: CHEESECHAIN_TESTNET_RPC_URL,
      accounts: [SIGNER_PRIVATE_KEY],
      chainId: 0,
    },
    proofofplayBoss: {
      url: PROOFOFPLAY_BOSS_RPC_URL,
      accounts: [SIGNER_PRIVATE_KEY],
      chainId: 70701,
    },
    proofofplayBossTestnet: {
      url: PROOFOFPLAY_BOSS_TESTNET_RPC_URL,
      accounts: [SIGNER_PRIVATE_KEY],
      chainId: 0,
    },
    proofofplayApex: {
      url: PROOFOFPLAY_APEX_RPC_URL,
      accounts: [SIGNER_PRIVATE_KEY],
      chainId: 70700,
    },
    proofofplayApexTestnet: {
      url: PROOFOFPLAY_APEX_TESTNET_RPC_URL,
      accounts: [SIGNER_PRIVATE_KEY],
      chainId: 0,
    },
    morph: {
  ...
  solidity: {
    ...
    settings: {
      ...
      // outputSelection: {
      //   "*": {
      //     "*": ["abi", "evm.bytecode", "evm.deployedBytecode", "evm.bytecode.sourceMap", "metadata"]
      //   }
      // }
    },
  },
  etherscan: {
    ...
    //   cheesechain: CHEESECHAIN_EXPLORER_API_KEY,
    //   cheesechainTestnet: CHEESECHAIN_EXPLORER_API_KEY,
    //   proofofplayBoss: PROOFOFPLAY_BOSS_EXPLORER_API_KEY,
    //   proofofplayBossTestnet: PROOFOFPLAY_BOSS_EXPLORER_API_KEY,
    //   proofofplayApex: PROOFOFPLAY_APEX_EXPLORER_API_KEY,
    //   proofofplayApexTestnet: PROOFOFPLAY_APEX_EXPLORER_API_KEY,
    //   morph: MORPH_EXPLORER_API_KEY,
    //   morphTestnet: MORPH_EXPLORER_API_KEY,
    //   ink: INK_EXPLORER_API_KEY,
    //   inkTestnet: INK_EXPLORER_API_KEY,
    //   soneium: SONEIUM_EXPLORER_API_KEY,
    //   soneiumTestnet: SONEIUM_EXPLORER_API_KEY,
    //   unichain: UNICHAIN_EXPLORER_API_KEY,
    //   unichainTestnet: UNICHAIN_EXPLORER_API_KEY,
    //   hyperevm: HYPEREVM_EXPLORER_API_KEY,
    //   hyperevmTestnet: HYPEREVM_EXPLORER_API_KEY,
    // },
    customChains: [
      {
        network: "celo",
      ...
      },
      {
        ...
        urls: {
          ...
          browserURL: "https://fetascan.xyz/"
        }
      },
      {
        network: "proofofplayBoss",
        chainId: 70701,
        urls: {
          apiURL: "https://explorer.boss.proofofplay.com/api",
          browserURL: "https://explorer.boss.proofofplay.com/"
        }
      },
      {
        network: "proofofplayApex",
        chainId: 70700,
        urls: {
      ...
      },
      {
        ...
        chainId: 0,
        urls: {
          apiURL: "https://explorer.unichain.org/api",
          browserURL: "https://explorer.unichain.org/"
        }
      },
      {
        network: "hyperevm",
